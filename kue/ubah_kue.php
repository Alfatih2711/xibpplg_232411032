...
<table border="1">
<tr>
    <td colspan="2" align="center">UBAH ULASAN KUE</td>
</tr>
<tr>
    <td>Kode Kue</td>
    <td><input type="text" name="kode" value="<?php echo $row['kodekue']; ?>" placeholder="Masukan Nama Kue" required></td>
</tr>
    <td>Nama Kue</td>
...
<tr>
    <td colspan="2" align="center"><input type="submit" name="ubah" value="UBAH">
